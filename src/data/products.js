...
const products = [
  {
    id: 1,
    title: "Still Life — Grapes & Fruit Harmony",
    category: "Painting",
    price: 489,
    description: "A rich and vibrant still life acrylic painting showcasing luscious purple grapes, apples, and seasonal fruits elegantly arranged in a bowl, captured with expressive brushwork and rich tones. Approx. Size: 10 × 12 inches.",
    material: "Acrylic",
    image: "1 a.jpg",
  ...
  {
    id: 2,
    title: "Morning Refreshment — Splash Study",
    category: "Pencil Drawing",
    price: 1499,
    description: "A masterful, highly expressive graphite pencil drawing capturing the vibrant kinetic energy of a boy splashing clear water onto his face, rendered with delicate shading and intricate droplet highlights. Approx. Size: 11 × 14 inches.",
    material: "Pencil",
    image: "2 a.jpg",
  ...
  {
    id: 3,
    title: "Dance of Shadows — Mini Canvas",
    category: "Painting",
    price: 299,
    description: "A delightful handmade acrylic artwork on miniature stretched canvas displayed on a tabletop easel, depicting a romantic dancing couple silhouette against a glowing twilight dusk. Approx. Size: 6 × 6 inches.",
    material: "Acrylic",
    image: "3 a.jpg",
  ...
  {
    id: 4,
    title: "Solitary Walk in the Rain",
    category: "Painting",
    price: 549,
    description: "A poetic and evocative acrylic painting portraying a solitary figure holding a bright red umbrella, strolling along a tranquil rain-washed forest pathway with atmospheric reflections. Approx. Size: 10 × 12 inches.",
    material: "Acrylic",
    image: "4 a.jpg",
  ...
  {
    id: 5,
    title: "Meadow of Daisies",
    category: "Painting",
    price: 369,
    description: "A soothing and cheerful acrylic floral painting featuring blooming white daisies with vibrant yellow centers set against a soft, textured pastoral background. Approx. Size: 9 × 12 inches.",
    material: "Acrylic",
    image: "5 a.jpg",
  ...
  {
    id: 6,
    title: "Basket of Spring Blooms",
    category: "Illustration",
    price: 289,
    description: "A delightful, colorful handmade artwork depicting an artisan basket overflowing with radiant spring wildflowers, tied with a graceful decorative ribbon bow. Approx. Size: 8 × 10 inches.",
  ...
  {
    id: 7,
    title: "Playful Expressions — Cartoon Piglet",
    category: "Illustration",
    price: 259,
    description: "An expressive handmade character artwork depicting a cheerful spotted piglet with a neat bow tie, created with lively line work and charming detailing. Approx. Size: 7 × 9 inches.",
    material: "Mixed Media",
    image: "7 a.jpg",
  ...
  {
    id: 8,
    title: "Sunny Garden Rose & Vase",
    category: "Illustration",
    price: 299,
    description: "A warm and cheerful handmade illustration featuring a radiant blooming orange rose in a table vase beside a friendly garden watering can basking in golden sunlight. Approx. Size: 8 × 10 inches.",
    material: "Mixed Media",
    image: "8 a.jpg",
